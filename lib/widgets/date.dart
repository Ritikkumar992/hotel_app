      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
                'Select the Check-In Check-Out Date',
              style: TextStyle(color: Colors.black, fontSize: 20.0),
            ),
            Text(
                'for Hotels Near ${widget.selectedString}',
              style: TextStyle(color: Colors.black, fontSize: 18.0),
            ),
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("Check-In", style: TextStyle(color:Colors.green, fontSize: 22.0),),
            ),
            Container(
            ...
            const Padding(
              padding: EdgeInsets.all(8.0),
              child: Text("Check-Out", style: TextStyle(color:Colors.green, fontSize: 22.0),),
            ),
            Container(
              decoration: BoxDecoration(
                border: Border.all(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Center(
                      child: ListTile(
                        subtitle: Center(child: Text(checkOutDate?.toString() ?? 'Check Out',
                          style: const TextStyle(
                            fontSize: 23,
                            fontWeight: FontWeight.w300,
                          ),
